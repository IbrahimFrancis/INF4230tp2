...
public class JeuConnect5 implements Runnable {
    ...
    public void run() {
        ...
        if(grilleObserver!=null) grilleObserver.changement(grille);
        int nextjoueur=0;
        int nbtours=0;
        forceStop = false;
        depassement[0] = depassement[1] = 0;
        while(gagnant==0 && grille.getNbCasesLibres()>0 && !forceStop){
            ...
            Position coup = joueurs[nextjoueur].getAction(copiegrille, tempsallouetour);
            ...
            if(grilleObserver!=null) grilleObserver.changement(grille);
            gagnant = verif.getGagnant(grille);
    ...
    public static void main(String args[]) throws Exception {
        BotInterne j1 = new BotInterne();
        BotInterne j2 = new BotInterne();
